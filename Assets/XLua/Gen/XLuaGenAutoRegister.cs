...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(BoringWorld.GameFrameworkExtension), BoringWorldGameFrameworkExtensionWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE0( GameFramework.IReference ir);
		
		delegate int __GEN_DELEGATE1( UnityGameFramework.Runtime.UIComponent uc,  BoringWorld.UIFormType formType);
		
		delegate int __GEN_DELEGATE2( UnityGameFramework.Runtime.UIComponent uc,  BoringWorld.UIFormType formType,  object userData);
		
		delegate void __GEN_DELEGATE3( GameFramework.DataTable.DataTableBase dtb,  object userData);
		
		delegate void __GEN_DELEGATE4( UnityGameFramework.Runtime.UIComponent uc,  UnityGameFramework.Runtime.UIFormLogic logic);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(GameFramework.IReference), new List<MethodInfo>(){
				
				  new __GEN_DELEGATE0(BoringWorld.GameFrameworkExtension.Release)
				...
				{typeof(UnityGameFramework.Runtime.UIComponent), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE1(BoringWorld.GameFrameworkExtension.OpenUIFormByType)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE2(BoringWorld.GameFrameworkExtension.OpenUIFormByType)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE4(BoringWorld.GameFrameworkExtension.CloseUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(GameFramework.DataTable.DataTableBase), new List<MethodInfo>(){
				
				  new __GEN_DELEGATE3(BoringWorld.GameFrameworkExtension.ReadDataByConfig)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
